...
//JWTGuard继承了laravel的基础认证接口Guard
class JWTGuard implements Guard
{
     ...
     * JWTGuard必须实现的接口attempt就是为了验证用户的用户名和密码是否匹配
     * @param  array  $credentials
     * @param  bool  $login  是否是登陆验证，false就是仅仅认证不登陆）
     *
     * @return bool|string
     */
     ...
     * 验证它的用户名密码（找到该用户并验证密码是否正确，是则登陆，否则401）
     * once不是原生guard的接口，是jwtGuard特有的
     * @param  array  $credentials
     *
     * @return bool
     */
