...
$router->get('/', function (\Illuminate\Support\Facades\Request $request) use ($router) {
...
//    {
////        $message->to('chenxiaolong@872140945');
...
Route::group(['prefix' => 'users'], function ($router) {
    ...
    //这个路由单独需要 认证中间件
    Route::post('me', ['middleware'=>'auth','uses'=>'UserController@me']);
